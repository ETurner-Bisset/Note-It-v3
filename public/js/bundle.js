    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status = 'success') {
            (0, _alerts.showAlert)('success', 'You have logged out successfully!');
            setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
exports.resetUserPassword = exports.forgotUserPassword = void 0;
...
var forgotUserPassword = exports.forgotUserPassword =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'A reset email has been sent.');
            window.setTimeout(function () {
  ...
  return function forgotUserPassword(_x) {
    return _ref.apply(this, arguments);
  };
}();

var resetUserPassword = exports.resetUserPassword =
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(password, passwordConfirm, token) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/users/resetPassword/".concat(token),
            data: {
              password: password,
              passwordConfirm: passwordConfirm
            }
  ...
  return function resetUserPassword(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"showPassword.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var togglePassword = exports.togglePassword = function togglePassword(input, btn) {
  if (btn) {
...
},{}],"moreItems.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.moreItems = void 0;

/* eslint-disable */
var addEventListener = function addEventListener(btnId, input) {
...
var moreItems = exports.moreItems = function moreItems(items, itemsContainer) {
  var newItem = document.createElement('div');
  newItem.classList.add('form-group');
  newItem.classList.add('form-item');
  newItem.innerHTML = "\n      <label class='form-label' for=\"item".concat(items.length + 1, "\">").concat(items.length + 1, ".</label>\n      <input type=\"text\" id=\"item").concat(items.length + 1, "\" class=\"form-input item\" name='item' >\n      <button class='btn voice-btn' id='item").concat(items.length + 1, "'><i class='fa-solid fa-microphone' ></i></button>\n      ");
  var btnId = newItem.childNodes[5];
  var input = newItem.childNodes[3];
  if (btnId) addEventListener(btnId, input);
  itemsContainer.appendChild(newItem);
};
},{}],"addNote.js":[function(require,module,exports) {
"use strict";
...
var addNote = exports.addNote =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(title, noteText, itemsArr) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Note created!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"showNote.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showNote = exports.searchNotes = void 0;
...
var showNote = exports.showNote =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(noteId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:8080/api/v1/notes/".concat(noteId));

        case 3:
          res = _context.sent;

          if (res.data.status === 'success') {
            location.assign("/".concat(noteId));
          }
  ...
  return function showNote(_x) {
    return _ref.apply(this, arguments);
  };
}();

var searchNotes = exports.searchNotes =
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(searchTitle) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            location.assign("/".concat(res.data.note.id));
          }
  ...
  return function searchNotes(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"voiceNote.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var voiceNote = exports.voiceNote = function voiceNote(btn, input) {
  window.SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition;
  var recognition = new SpeechRecognition();
  recognition.interimResults = true;
...
},{}],"noteFunctions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.undoDoneItem = exports.editNote = exports.editItem = exports.deleteNote = exports.deleteList = exports.deleteItem = exports.clearDoneList = exports.addToDoneList = exports.addItem = void 0;
...
var deleteNote = exports.deleteNote =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:8080/api/v1/notes/".concat(noteId)
          });
        ...
        case 3:
          ...
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Note deleted');
            setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var addItem = exports.addItem =
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(noteId, item) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/notes/".concat(noteId, "/addItem"),
            data: {
              item: item
            }
          });
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'An item has been added.');
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
...
var editNote = exports.editNote =
/*#__PURE__*/
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee3(noteId, newInput) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your note was updated.');
            setTimeout(function () {
              location.assign("/".concat(noteId));
            }, 1500);
          }
  ...
  return function editNote(_x4, _x5) {
    return _ref3.apply(this, arguments);
  };
}();

var addToDoneList = exports.addToDoneList =
/*#__PURE__*/
function () {
  var _ref4 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee4(noteId, item) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/notes/".concat(noteId, "/doneList"),
            data: {
              item: item
            }
          });
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Item moved to your done list.');
            setTimeout(function () {
              location.assign("/".concat(noteId));
            }, 1500);
          }
  ...
  return function addToDoneList(_x6, _x7) {
    return _ref4.apply(this, arguments);
  };
}();

var undoDoneItem = exports.undoDoneItem =
/*#__PURE__*/
function () {
  var _ref5 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee5(noteId, item) {
    var res;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/notes/".concat(noteId, "/undo"),
            data: {
              item: item
            }
          });
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Item moved to your list.');
            setTimeout(function () {
              location.assign("/".concat(noteId));
            }, 1500);
          }
  ...
  return function undoDoneItem(_x8, _x9) {
    return _ref5.apply(this, arguments);
  };
}();

var editItem = exports.editItem =
/*#__PURE__*/
function () {
  var _ref6 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee6(noteId, itemId, updatedItem) {
    var res;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/notes/".concat(noteId, "/items/").concat(itemId),
            data: {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'An item has been edited.');
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function editItem(_x10, _x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();

var deleteItem = exports.deleteItem =
/*#__PURE__*/
function () {
  var _ref7 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee7(noteId, itemId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'An item has been deleted.');
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function deleteItem(_x13, _x14) {
    return _ref7.apply(this, arguments);
  };
}();

var clearDoneList = exports.clearDoneList =
/*#__PURE__*/
function () {
  var _ref8 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee8(noteId, emArr) {
    var res;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/notes/".concat(noteId, "/clearDone"),
            data: {
              emArr: emArr
            }
          });
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Done list has been deleted.');
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function clearDoneList(_x15, _x16) {
    return _ref8.apply(this, arguments);
  };
}();

var deleteList = exports.deleteList =
/*#__PURE__*/
function () {
  var _ref9 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee9(noteId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8080/api/v1/notes/".concat(noteId, "/deleteList")
          });
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'List deleted');
            setTimeout(function () {
              location.reload();
            }, 1500);
          }
  ...
  return function deleteList(_x17) {
    return _ref9.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"toggleBtns.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toggleItemBtnsVis = exports.toggleBtnVis = void 0;

/* eslint-disable */
var toggleBtnVis = exports.toggleBtnVis = function toggleBtnVis(btnPencil, input, text, btnTick, btnDelete) {
  if (btnPencil) {
...
var toggleItemBtnsVis = exports.toggleItemBtnsVis = function toggleItemBtnsVis(btnPencil, input, text, btnTick, btnDelete) {
  if (btnPencil) {
    btnPencil.addEventListener('click', function (e) {
      e.preventDefault();
      text.style.fontSize = '0px';
...
},{}],"accountFunctions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateSettings = exports.deleteAccount = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type === 'password' ? 'Password' : 'Information', " updated successfully!"));
            window.setTimeout(function () {
...
var deleteAccount = exports.deleteAccount =
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Your account has been deleted.');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"contact.js":[function(require,module,exports) {
"use strict";
...
var sendContactEmail = exports.sendContactEmail = function sendContactEmail(json) {
  try {
...
var _moreItems = require("./moreItems");

var _addNote = require("./addNote");

var _showNote = require("./showNote");

var _voiceNote = require("./voiceNote");

var _noteFunctions = require("./noteFunctions");

var _toggleBtns = require("./toggleBtns");

var _accountFunctions = require("./accountFunctions");
...
// DOM selectors
// Dropdown menu
var dropdown1 = document.getElementById('nav-id');
var dropdown2 = document.getElementById('nav-id-bars');
var dropdownMenu1 = document.querySelector('.dropdown-menu1');
var dropdownMenu2 = document.querySelector('.dropdown-menu2');
var mainContainer = document.querySelector('main'); // Login, sign up and reset password

var loginForm = document.getElementById('login-form');
var logoutBtn = document.querySelector('.logout');
var logoutBtnMob = document.querySelector('.logout-mobile');
...
var signupPasswordInput = document.getElementById('password-signup');
var toggleShowPassword = document.getElementById('togglePassword');
var loginPasswordInput = document.getElementById('password-login');
var toggleShowLoginPassword = document.getElementById('togglePasswordLogin');
var resetPasswordInput = document.getElementById('reset-password');
var toggleShowResetPassword = document.getElementById('togglePasswordReset'); // Note selectors

var moreItemsBtn = document.getElementById('more-items');
var addNoteForm = document.getElementById('add-note');
var titleBtn = document.getElementById('title-btn');
var title = document.getElementById('title');
var noteTextBtn = document.getElementById('text-btn');
var noteText = document.getElementById('note-text');
var formItems = document.querySelectorAll('.form-item');
var showNoteBtns = document.querySelectorAll('.show-note');
var deleteNoteBtn = document.querySelector('.btn-delete-note');
var addItemBtn = document.querySelector('.btn-add-item');
var editTitleBtn = document.getElementById('edit-title');
var editTitleInput = document.getElementById('editTitleInput');
var titleTickBtn = document.querySelector('.title-tick');
var titleText = document.getElementById('title-text');
var editTextBtn = document.getElementById('edit-text');
var editTextInput = document.getElementById('editNoteInput');
var textTickBtn = document.querySelector('.text-tick');
var noteTextP = document.querySelector('.note-text-p');
var btnDeleteText = document.getElementById('delete-text');
var listItems = document.querySelectorAll('.list-item');
var itemTickBtns = document.querySelectorAll('.item-tick');
var itemDeleteBtns = document.querySelectorAll('.fa-trash');
var clearDoneBtn = document.querySelector('.btn-clear');
var undoBtns = document.querySelectorAll('.btn-undo');
var deleteListBtn = document.querySelector('.btn-delete-list');
var searchForm = document.getElementById('search-form'); // Modal

var modal = document.getElementById('text-modal');
var openModalBtn = document.querySelector('.btn-add-text');
var modalSpan = document.querySelector('.close');
var listModal = document.getElementById('list-modal');
var openListModalBtn = document.querySelector('.btn-add-list');
var modalListSpan = document.querySelector('.close-list'); // Modal forms and btns

var addTextForm = document.getElementById('add-text');
var addListForm = document.getElementById('add-list'); // Account

var currentPasswordInput = document.getElementById('current-password');
var toggleShowCurrentPassword = document.getElementById('togglePasswordAccount');
var newPasswordInput = document.getElementById('new-password');
var toggleShowNewPassword = document.getElementById('togglePasswordAccountNew');
var updatePasswordForm = document.getElementById('update-password');
var updateInfoForm = document.getElementById('update-info');
var deleteAccountForm = document.getElementById('delete-account'); // Contact page

var contactForm = document.getElementById('contact-form'); // Show password

(0, _showPassword.togglePassword)(signupPasswordInput, toggleShowPassword);
(0, _showPassword.togglePassword)(loginPasswordInput, toggleShowLoginPassword);
(0, _showPassword.togglePassword)(resetPasswordInput, toggleShowResetPassword);
(0, _showPassword.togglePassword)(currentPasswordInput, toggleShowCurrentPassword);
(0, _showPassword.togglePassword)(newPasswordInput, toggleShowNewPassword); // Open dropdown menus
...
if (logoutBtnMob) logoutBtnMob.addEventListener('click', _login.logout); // Sign up
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _forgotPassword.forgotUserPassword)(email);
  });
} // Reset password
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('reset-passwordConfirm').value;
    var token = e.target.action.split('/')[4];
    (0, _forgotPassword.resetUserPassword)(password, passwordConfirm, token);
  });
...
if (moreItemsBtn) {
  moreItemsBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var items = document.getElementsByClassName('form-item');
    var itemsContainer = document.querySelector('.items-container');
    (0, _moreItems.moreItems)(items, itemsContainer);
  });
} // Voice note


(0, _voiceNote.voiceNote)(titleBtn, title);
(0, _voiceNote.voiceNote)(noteTextBtn, noteText);
formItems.forEach(function (item) {
  return (0, _voiceNote.voiceNote)(item.childNodes[3], item.childNodes[2]);
}); // Add note
...
if (addNoteForm) {
  addNoteForm.addEventListener('submit', function (e) {
    ...
    (0, _addNote.addNote)(title, noteText, itemsArr);
  });
} // Show note


if (showNoteBtns) {
  showNoteBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var noteId = e.target.id;
      (0, _showNote.showNote)(noteId);
    });
  });
} // Open/close modals
...
if (openListModalBtn) {
  openListModalBtn.addEventListener('click', function (e) {
    e.preventDefault();
...
if (modalListSpan) {
  modalListSpan.addEventListener('click', function (e) {
    e.preventDefault();
...
if (addTextForm) {
  addTextForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var noteText = document.getElementById('note-text').value;
    var noteId = e.target.childNodes[2].childNodes[1].id;
    (0, _noteFunctions.editNote)(noteId, {
      noteText: noteText
    });
  });
}
...
if (addListForm) {
  addListForm.addEventListener('submit', function (e) {
    ...
    var itemsArr = [];
    var items = document.querySelectorAll('.item');
    var noteId = e.target.childNodes[1].childNodes[0].id;
    items.forEach(function (item) {
      if (item.value !== '') {
        (0, _noteFunctions.addItem)(noteId, item.value);
      }
    });
  });
} // Delete note
...
if (deleteNoteBtn) {
  deleteNoteBtn.addEventListener('click', function (e) {
    ...
    (0, _noteFunctions.deleteNote)(noteId);
  });
} // Add item
...
if (addItemBtn) {
  addItemBtn.addEventListener('click', function (e) {
    ...
    if (item !== '') {
      (0, _noteFunctions.addItem)(noteId, item);
    }
  });
} // Toggle edit btns visibility


(0, _toggleBtns.toggleBtnVis)(editTitleBtn, editTitleInput, titleText, titleTickBtn);
(0, _toggleBtns.toggleBtnVis)(editTextBtn, editTextInput, noteTextP, textTickBtn, btnDeleteText);
listItems.forEach(function (item) {
  (0, _toggleBtns.toggleItemBtnsVis)(item.childNodes[1].childNodes[0], item.childNodes[1].childNodes[1].childNodes[0], item, item.childNodes[1].childNodes[1].childNodes[1], item.childNodes[1].childNodes[2]);
}); // Edit note title

if (titleTickBtn) {
  titleTickBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var noteId = e.target.id;
    var newInput = document.getElementById('editTitleInput').value;
    if (!noteId) return location.reload();
    (0, _noteFunctions.editNote)(noteId, {
      title: newInput
    });
...
if (textTickBtn) {
  textTickBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var noteId = e.target.id;
    var newInput = document.getElementById('editNoteInput').value;
    if (!noteId) return location.reload();
    (0, _noteFunctions.editNote)(noteId, {
      noteText: newInput
    });
...
if (itemTickBtns) {
  itemTickBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var itemId = e.target.id;
      var item = e.target.parentNode.parentNode.childNodes[0].value;
      var noteId = e.target.parentNode.parentNode.parentNode.id;
      if (!noteId) return location.reload();
      (0, _noteFunctions.editItem)(noteId, itemId, item);
    });
  });
...
if (itemDeleteBtns) {
  itemDeleteBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var itemId = e.target.id;
      var noteId = e.target.parentNode.parentNode.id;
      if (!noteId) return location.reload();
      (0, _noteFunctions.addToDoneList)(noteId, itemId);
    });
  });
} // Clear done list
...
if (clearDoneBtn) {
  clearDoneBtn.addEventListener('click', function (e) {
    ...
    var noteId = e.target.id;
    var emArr = [];
    (0, _noteFunctions.clearDoneList)(noteId, emArr);
    if (!noteId) return location.reload();
  });
} // Undo done items
...
if (undoBtns) {
  undoBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      if (!noteId) return location.reload();
      (0, _noteFunctions.undoDoneItem)(noteId, itemId);
    });
  });
}
...
if (deleteListBtn) {
  deleteListBtn.addEventListener('click', function (e) {
    ...
    var noteId = e.target.id;
    var itemIdArr = [];
    var itemId = e.target.parentNode.parentNode.childNodes[2].childNodes.forEach(function (item) {
      if (item.id !== undefined) {
        itemIdArr.push(item.id);
      }
    });
    itemIdArr.forEach(function (item) {
      return (0, _noteFunctions.deleteItem)(noteId, item);
    });
    (0, _noteFunctions.deleteList)(noteId);
  });
} // Search function
...
if (searchForm) {
  searchForm.addEventListener('submit', function (e) {
    ...
    (0, _showNote.searchNotes)(searchTitle);
  });
} // Account page
// Update password
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _accountFunctions.updateSettings)({
          ...
          case 7:
            document.querySelector('.btn-update-password').textContent = 'Update Password';
...
if (updateInfoForm) {
  updateInfoForm.addEventListener('submit', function (e) {
    ...
    (0, _accountFunctions.updateSettings)({
      name: name,
      email: email
    }, 'data');
  });
...
if (deleteAccountForm) {
  deleteAccountForm.addEventListener('submit', function (e) {
    ...
    if (!checkbox) {
      (0, _alerts.showAlert)('error', 'Check the box to delete your account.');
    } else {
      (0, _accountFunctions.deleteAccount)();
    }
  });
} // Contact form
...
if (contactForm) {
  contactForm.addEventListener('submit', function (e) {
    ...
    (0, _contact.sendContactEmail)(json);
  });
}
},{"./login":"login.js","./signup":"signup.js","./forgotPassword":"forgotPassword.js","./showPassword":"showPassword.js","./moreItems":"moreItems.js","./addNote":"addNote.js","./showNote":"showNote.js","./voiceNote":"voiceNote.js","./noteFunctions":"noteFunctions.js","./toggleBtns":"toggleBtns.js","./accountFunctions":"accountFunctions.js","./contact":"contact.js","./alerts":"alerts.js"}],"../../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
